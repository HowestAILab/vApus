...
namespace SpreadsheetLight.Charts
{
    ...
    public abstract class EGAxShared : SLChartAlignment
    {
        ...
        internal EGAxShared(List<System.Drawing.Color> ThemeColors)
        {
            this.AxisId = 0;
            this.LogBase = null;
            ...
            this.MajorGridlines = new SLMajorGridlines(ThemeColors);
            this.ShowMinorGridlines = false;
            this.MinorGridlines = new SLMinorGridlines(ThemeColors);

            this.ShowTitle = false;
            this.Title = new SLTitle(ThemeColors);

            this.sFormatCode = "General";
