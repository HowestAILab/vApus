...
namespace SpreadsheetLight.Charts
{
    ...
    public class SLDataPointOptions
    {
        ...
        internal C.DataPoint ToDataPoint(int index)
        {
            C.DataPoint pt = new C.DataPoint();

            pt.Index = new C.Index() { Val = (uint)index };

            if (this.Marker.HasMarker) pt.Marker = this.Marker.ToMarker();
            ...
            if (this.ShapeProperties.HasShapeProperties) pt.ChartShapeProperties = this.ShapeProperties.ToChartShapeProperties();
