...
namespace SpreadsheetLight.Charts
{
    internal class SLDataSeries
    {
        ...
        internal C.RadarChartSeries ToRadarChartSeries()
        {
            ...
            if (this.Options.ShapeProperties.HasShapeProperties)
            {
                rcs.ChartShapeProperties = this.Options.ShapeProperties.ToChartShapeProperties();
            }

            if (this.Options.Marker.HasMarker)
            {
                rcs.Marker = this.Options.Marker.ToMarker();
            }
            ...
            if (this.DataPointOptionsList.Count > 0)
            {
                ...
                {
                    index = indexlist[i];
                    rcs.Append(this.DataPointOptionsList[index].ToDataPoint(index));
                }
            }
        ...
        internal C.AreaChartSeries ToAreaChartSeries()
        {
            ...
            if (this.Options.ShapeProperties.HasShapeProperties)
            {
                acs.ChartShapeProperties = this.Options.ShapeProperties.ToChartShapeProperties();
            }
            ...
            if (this.DataPointOptionsList.Count > 0)
            {
                ...
                {
                    index = indexlist[i];
                    acs.Append(this.DataPointOptionsList[index].ToDataPoint(index));
                }
            }
        ...
        internal C.BarChartSeries ToBarChartSeries()
        {
            ...
            if (this.Options.ShapeProperties.HasShapeProperties)
            {
                bcs.ChartShapeProperties = this.Options.ShapeProperties.ToChartShapeProperties();
            }
            ...
            if (this.DataPointOptionsList.Count > 0)
            {
                ...
                {
                    index = indexlist[i];
                    bcs.Append(this.DataPointOptionsList[index].ToDataPoint(index));
                }
            }
        ...
        internal C.ScatterChartSeries ToScatterChartSeries()
        {
            ...
            if (this.Options.ShapeProperties.HasShapeProperties)
            {
                scs.ChartShapeProperties = this.Options.ShapeProperties.ToChartShapeProperties();
            }

            if (this.Options.Marker.HasMarker)
            {
                scs.Marker = this.Options.Marker.ToMarker();
            }
            ...
            if (this.DataPointOptionsList.Count > 0)
            {
                ...
                {
                    index = indexlist[i];
                    scs.Append(this.DataPointOptionsList[index].ToDataPoint(index));
                }
            }
        ...
        internal C.LineChartSeries ToLineChartSeries()
        {
            ...
            if (this.Options.ShapeProperties.HasShapeProperties)
            {
                lcs.ChartShapeProperties = this.Options.ShapeProperties.ToChartShapeProperties();
            }

            if (this.Options.Marker.HasMarker)
            {
                lcs.Marker = this.Options.Marker.ToMarker();
            }
            ...
            if (this.DataPointOptionsList.Count > 0)
            {
                ...
                {
                    index = indexlist[i];
                    lcs.Append(this.DataPointOptionsList[index].ToDataPoint(index));
                }
            }
        ...
        internal C.BubbleChartSeries ToBubbleChartSeries()
        {
        ...
        internal C.SurfaceChartSeries ToSurfaceChartSeries()
        {
