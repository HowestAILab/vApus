...
namespace SpreadsheetLight.Charts
{
    ...
    public class SLTextAxis : EGAxShared
    {
        ...
        {
            if (this.AxisType != SLAxisType.Value) this.AxisType = SLAxisType.Category;
        }
        ...
        {
            if (this.AxisType != SLAxisType.Value) this.AxisType = SLAxisType.Date;
        }
        ...
        internal C.CategoryAxis ToCategoryAxis()
        {
            ...
            {
                ca.MajorGridlines = this.MajorGridlines.ToMajorGridlines();
            }

            if (this.ShowMinorGridlines)
            {
                ca.MinorGridlines = this.MinorGridlines.ToMinorGridlines();
            }

            if (this.ShowTitle)
            {
                ca.Title = this.Title.ToTitle();
            }
            ...
            if (this.ShapeProperties.HasShapeProperties) ca.ChartShapeProperties = this.ShapeProperties.ToChartShapeProperties();
            ...
            ca.Append(new C.AutoLabeled() { Val = true });
        ...
        internal C.ValueAxis ToValueAxis()
        {
            ...
            if (this.ShowMajorGridlines)
            {
                va.MajorGridlines = this.MajorGridlines.ToMajorGridlines();
            }

            if (this.ShowMinorGridlines)
            {
                va.MinorGridlines = this.MinorGridlines.ToMinorGridlines();
            }

            if (this.ShowTitle)
            {
                va.Title = this.Title.ToTitle();
            }
            ...
            if (this.ShapeProperties.HasShapeProperties) va.ChartShapeProperties = this.ShapeProperties.ToChartShapeProperties();
