...
namespace SpreadsheetLight.Charts
{
    ...
    public class SLTitle : SLChartAlignment
    {
        ...
        internal SLTitle(List<System.Drawing.Color> ThemeColors)
        {
        ...
        internal C.Title ToTitle()
        {
            ...
            if (this.ShapeProperties.HasShapeProperties) t.ChartShapeProperties = this.ShapeProperties.ToChartShapeProperties();
