...
namespace SpreadsheetLight
{
    public partial class SLDocument
    {
        ...
        public bool SetDefinedName(string Name, string Text, string Comment, string Scope)
        {
            ...
            {
                if (slwb.Sheets[i].Name.Equals(Scope, StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        private void SetAddPrintArea(int StartRowIndex, int StartColumnIndex, int EndRowIndex, int EndColumnIndex, bool ToAdd)
        {
            ...
            {
                if (slwb.Sheets[i].Name.Equals(gsSelectedWorksheetName, StringComparison.InvariantCultureIgnoreCase))
                {
                    iSheetPosition = i;
                    break;
                }
            ...
            {
                if (slwb.DefinedNames[i].Name.Equals(SLConstants.PrintAreaDefinedName, StringComparison.InvariantCultureIgnoreCase)
