    ...
    internal class SLSimpleTheme
    {
        ...
        internal void CalculateRowColumnInfo()
        {
            ...
            using (System.Drawing.Bitmap bmGraphics = new System.Drawing.Bitmap(iBitmapWidth, iBitmapHeight))
            {
                ...
                if (this.MinorLatinFont.Equals("Rockwell Condensed", StringComparison.InvariantCultureIgnoreCase)
                    || this.MinorLatinFont.Equals("Tw Cen MT Condensed", StringComparison.InvariantCultureIgnoreCase))
                {
                    // this is for 96 DPI
                    if (bmGraphics.HorizontalResolution < 108)
                    {
