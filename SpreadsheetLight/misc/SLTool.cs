...
namespace SpreadsheetLight
{
    ...
    internal partial class SLTool
    {
        ...
        internal static SizeF MeasureText(Bitmap bm, Graphics g, string Text, Font UsableFont)
        {
            ...
            szf = g.MeasureString(string.Format("_{0}_", Text), UsableFont);
            szf.Width = szf.Width - fDoubleUnderscoreWidth;
            ...
            szf.Height = (szf.Height + (float)TextRenderer.MeasureText(Text, UsableFont).Height) / 2.0f;
