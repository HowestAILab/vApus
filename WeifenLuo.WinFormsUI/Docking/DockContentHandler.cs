...
namespace WeifenLuo.WinFormsUI.Docking
{
	...
	public class DockContentHandler : IDisposable, IDockDragSource
	{
		...
		internal void SetDockState(bool isHidden, DockState visibleState, DockPane oldPane)
		{
			...
			if (cea.Cancel == true || IsSuspendSetDockState)
				return;
        ...
        public void Show(DockPanel dockPanel, DockState dockState)
        {
            ...
            else
            {
                ...
                if (dockPanel.Tag == null)
                    ...
                    tag = new object[] { dockState, dockPanel.Tag };

                dockPanel.Tag = tag;
                dockPanel.HandleCreated += new EventHandler(dockPanel_HandleCreated);
            }
        }
        private void dockPanel_HandleCreated(object sender, EventArgs e)
        {
            ...
            object[] tag = dockPanel.Tag as object[];
            DockState dockState = (DockState)tag[0];
            if (tag.Length == 2)
                dockPanel.Tag = tag[1];
