...
namespace vApus.DistributedTesting
{
    ...
    public class TileStresstestProgressResults : ITileProgressResult
    {
        ...
        [NonSerialized] private readonly StresstestResults _stresstestResults;

        private readonly List<TileConcurrencyProgressResult> _tileConcurrencyProgressResults =
            new List<TileConcurrencyProgressResult>();
    ...
    public class TileConcurrencyProgressResult : ITileProgressResult
    {
        ...
        [NonSerialized] private readonly ConcurrencyResult _concurrentUsersResult;
        private readonly List<TileRunProgressResult> _tileRunProgressResults = new List<TileRunProgressResult>();
        private TimeSpan _estimatedRuntimeLeft;
        private Metrics _metrics;
    ...
    public class TileRunProgressResult : ITileProgressResult
    {
        ...
        [NonSerialized] private readonly RunResult _runResult;
        private TimeSpan _estimatedRuntimeLeft;
        private Metrics _metrics;
