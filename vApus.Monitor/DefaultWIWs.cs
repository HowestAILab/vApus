...
namespace vApus.Monitor {
    internal static class DefaultWIWs {
        ...
        private static string _dstat = "[{\"name\":\"FOO\",\"isAvailable\":true,\"subs\":[{\"name\":\"procs\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"memory usage\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"paging\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"dsk/total\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"system\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"total cpu usage\",\"subs\":[{\"name\":\"*\"}]},{\"name\":\"net/total\",\"subs\":[{\"name\":\"*\"}]}]}]";
