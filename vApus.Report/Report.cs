    ...
    public partial class Report : Form
    {
        ...
        public Report(string fileName = null)
        {
            ...
            if (IsHandleCreated)
                ...
                HandleCreated += Report_HandleCreated;
        }
        ...
        private void LoadControlFromCurrentDirectory()
        {
            ...
            Assembly ass =
                _reportAppDomain.Load(
                    File.ReadAllBytes(Path.Combine(_assemblyDirs[_currentAssemblyDirIndex], STRESSTESTDLL)));
            ...
            var stresstestReportControl = Activator.CreateInstance(t) as UserControl;
            ...
            MethodInfo handler = typeof (Report).GetMethod("stresstestReportControl_LoadingError",
        ...
        private void stresstestReportControl_LoadingError(object sender, ErrorEventArgs e)
        {
            ...
            {
                _currentAssemblyDirIndex = 0;
                MessageBox.Show(this, e.GetException().ToString(), string.Empty, MessageBoxButtons.OK,
        ...
        {
            Text = "Report - " + _fileName;
            Control control = pnlPlaceHolder.Controls[0];
            control.GetType()
                   .InvokeMember("LoadRFile", BindingFlags.Default | BindingFlags.InvokeMethod, null, control,
