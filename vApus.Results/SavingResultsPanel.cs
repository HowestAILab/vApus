    ...
    public partial class SavingResultsPanel : Panel {
        ...
        private void btnTest_Click(object sender, EventArgs e) {
            ...
            var dba = new DatabaseActions {
                ConnectionString = string.Format("Server={0};Port={1};Uid={2};Pwd={3};Pooling=True;UseCompression=True;table cache = true;", txtHost.Text, (int)nudPort.Value, txtUser.Text, txtPassword.Text)
            };
