namespace vApus.StressTest
{
    partial class FastResultsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.kvpStressTest = new RandomUtils.KeyValuePairControl();
            this.kvpConnection = new RandomUtils.KeyValuePairControl();
            this.kvpConnectionProxy = new RandomUtils.KeyValuePairControl();
            this.kvpScenario = new RandomUtils.KeyValuePairControl();
            this.kvpScenarioRuleSet = new RandomUtils.KeyValuePairControl();
            this.kvpMonitor = new RandomUtils.KeyValuePairControl();
            this.kvpConcurrencies = new RandomUtils.KeyValuePairControl();
            this.kvpRuns = new RandomUtils.KeyValuePairControl();
            this.kvpInitialDelay = new RandomUtils.KeyValuePairControl();
            this.kvpDelay = new RandomUtils.KeyValuePairControl();
            this.kvpShuffle = new RandomUtils.KeyValuePairControl();
            this.kvpActionDistribution = new RandomUtils.KeyValuePairControl();
            this.kvpMaximumNumberOfUserActions = new RandomUtils.KeyValuePairControl();
            this.kvpMonitorBefore = new RandomUtils.KeyValuePairControl();
            this.kvpMonitorAfter = new RandomUtils.KeyValuePairControl();
            this.kvpParallelExecutions = new RandomUtils.KeyValuePairControl();
            ...
            this.kvmCPUUsage = new RandomUtils.KeyValuePairControl();
            this.kvmMemoryUsage = new RandomUtils.KeyValuePairControl();
            this.kvmThreadsInUse = new RandomUtils.KeyValuePairControl();
            this.kvmNic = new RandomUtils.KeyValuePairControl();
            this.kvmNicsSent = new RandomUtils.KeyValuePairControl();
            this.kvmNicsReceived = new RandomUtils.KeyValuePairControl();
    ...
    "ill the end of the test for tests with low delays.";
        ...
        private RandomUtils.KeyValuePairControl kvpStressTest;
        private RandomUtils.KeyValuePairControl kvpConnection;
        private RandomUtils.KeyValuePairControl kvpConnectionProxy;
        private RandomUtils.KeyValuePairControl kvpScenario;
        private RandomUtils.KeyValuePairControl kvpConcurrencies;
        private RandomUtils.KeyValuePairControl kvpRuns;
        private RandomUtils.KeyValuePairControl kvpInitialDelay;
        private RandomUtils.KeyValuePairControl kvpDelay;
        private RandomUtils.KeyValuePairControl kvpShuffle;
        private RandomUtils.KeyValuePairControl kvpActionDistribution;
        ...
        private RandomUtils.KeyValuePairControl kvmThreadsInUse;
        private RandomUtils.KeyValuePairControl kvmCPUUsage;
        private RandomUtils.KeyValuePairControl kvmMemoryUsage;
        private RandomUtils.KeyValuePairControl kvmNic;
        private RandomUtils.KeyValuePairControl kvmNicsSent;
        private RandomUtils.KeyValuePairControl kvmNicsReceived;
        private RandomUtils.KeyValuePairControl kvpScenarioRuleSet;
        ...
        private RandomUtils.KeyValuePairControl kvpMonitorBefore;
        private RandomUtils.KeyValuePairControl kvpMonitorAfter;
        private RandomUtils.KeyValuePairControl kvpParallelExecutions;
        ...
        private RandomUtils.KeyValuePairControl kvpMaximumNumberOfUserActions;
        private RandomUtils.KeyValuePairControl kvpMonitor;
    }
}
