...
namespace vApus.Stresstest
{
    ...
    public class Rule : LabeledBaseItem
    {
        ...
        private string _regExp = string.Empty, _description = string.Empty;
        ...
        [Description("The actual rule. [http://www.google.com/search?q=regular+expressions]"), DisplayName("Regular Expression")]
        ...
        [Description("If implemented, textual input will be displayed using the password character. Where this is implemented encryption is always used."), DisplayName("Use Password Character")]
        ...
        #region Constructors
        /// <summary>
        /// This is at the moment a very narrow implementation. The only check is against ValueString, if it is equal or contained within the input string (ValueModifier).
        /// </summary>
        ...
        private object CastOrParseInputToType(object input, ValueTypes valueType)
        {
            ...
            {
                throw new Exception("Please make sure the \"Value to Check Against\" is castable/parsable to the selected \"Value Type\".");
            }
        }
