...
namespace vApus.Stresstest
{
    ...
    public class Rule : LabeledBaseItem
    {
        ...
        public enum ValueTypes
        {
            ...
            [Description("Single character")] charType,
            [Description("16-bit integer")] shortType,
            [Description("32-bit integer")] intType,
            [Description("64-bit integer")] longType,
            [Description("Unsigned 16-bit integer")] ushortType,
            [Description("Unsigned 32-bit integer")] uintType,
            [Description("Unsigned 64-bit integer")] ulongType,
            [Description("32-bit floating point")] floatType,
            [Description("Numeric")] doubleType,
            [Description("Decimal")] decimalType,
            [Description("Boolean")] boolType
        }
