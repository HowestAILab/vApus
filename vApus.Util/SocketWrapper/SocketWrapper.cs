...
namespace vApus.Util
{
    ...
    public class SocketWrapper
    {
        ...
        private ManualResetEvent _connectWaitHandle;
        ...
        public SocketWrapper(string ip, int port, Socket socket, SocketFlags receiveSocketFlags = SocketFlags.None, SocketFlags sendSocketFlags = SocketFlags.None)
        ...
        /// <param name="receiveSocketFlags"></param>
        /// <param name="sendSocketFlags"></param>
        public SocketWrapper(IPAddress ip, int port, Socket socket, SocketFlags receiveSocketFlags = SocketFlags.None, SocketFlags sendSocketFlags = SocketFlags.None)
        {
            if (ip == null)
        ...
        private object SoapToObject(string soap)
        {
            //TODO: surrogate for non-serializable classes?
            SoapFormatter sf = new SoapFormatter();
            MemoryStream ms = new MemoryStream(System.Text.Encoding.ASCII.GetBytes(soap));
