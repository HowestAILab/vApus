...
namespace vApus.Util {
    public class SpecialFolder {
        ...
        [DllImport("SHFolder", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall,
            SetLastError = true)]
        private static extern int SHGetFolderPath(IntPtr hwnd, Folder folder, IntPtr accessToken, int flags,
